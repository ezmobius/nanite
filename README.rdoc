...
and bring up the {Nanite Control Tower}[http://localhost:4000].

Have fun!

== Web Framework Integration

The integration of Nanite depends on two

Since Thin uses EventMachine, we can only need to make sure that the EventMachine reactor is already running
